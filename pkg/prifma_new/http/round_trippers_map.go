...
type RoundTrippersMap interface {
	Get(result prifma_new.HandleRequestResult) http.RoundTripper
}
...
func (t *SyncRoundTrippersMap) Get(result prifma_new.HandleRequestResult) http.RoundTripper {
...
func NewRoundTripperKey(result prifma_new.HandleRequestResult) RoundTripperKey {
	t := RoundTripperKey{}
